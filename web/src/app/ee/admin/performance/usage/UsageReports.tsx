...
function GenerateReportInput({
  ...
  return (
    <div className="mb-8">
      <Title className="mb-2">Générer des rapports d&apos;utilisation</Title>
      <Text as="p">Générez des statistiques d&apos;utilisation pour les utilisateurs de l&apos;espace de travail.</Text>
      <Spacer rem={2} />
      ...
      >
        {isWaitingForReport ? "Génération..." : "Générer le rapport"}
      </OpalButton>
      <p className="mt-1 text-xs">
        {isWaitingForReport
          ? "Un rapport est en cours de génération. Veuillez patienter..."
          : "La génération du rapport s'exécute en arrière-plan. Consultez la section « Rapports précédents » ci-dessous pour télécharger lorsqu'il est prêt."}
      </p>
      {errorOccurred && (
        <ErrorCallout
...
function UsageReportsTable({
  ...
  return (
    <div>
      <Title className="mb-2 mt-6 mx-auto"> Rapports précédents </Title>
          ...
          <Table>
            <TableHeader>
              <TableRow>
                ...
                <TableHead>Heure de génération</TableHead>
            ...
            <TableBody>
              {paginatedReports.map((r) => (
                <TableRow key={r.report_name}>
                  ...
                  <TableCell>{r.requestor ?? "Généré automatiquement"}</TableCell>
                  <TableCell>
...
export default function UsageReports() {
  ...
  const handleReportGenerated = () => {
    ...
    timeoutRef.current = setTimeout(() => {
      ...
      setTimeoutMessage(
        "La génération du rapport prend plus de temps que prévu. Le rapport continuera à être généré en arrière-plan. Veuillez revérifier dans quelques minutes."
      );
